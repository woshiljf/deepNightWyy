<template>
  ...
  <div class="myMusic-container">
    ...
    <el-container style="height: 100vh; border: 1px solid #eee">
      <el-aside width="300px" style="background-color: rgb(238, 241, 246)" class="menu-side">
        <el-menu :default-openeds="['2']">
          ...
          <el-submenu index="2">
            ...
            <el-menu-item :index="item.name" v-for="item in buildPlayList" :key="item.id" class="songs-menue"
              @click="getSongs(item.id,item.coverImgUrl,item.description,item.name)" style="padding-left: 20px">
          ...
          <el-submenu index="3">
            ...
            <el-menu-item :index="item.name" v-for="item in collectPlayList" :key="item.id" class="songs-menue"
              @click="getSongs(item.id,item.coverImgUrl,item.description,item.name)" style="padding-left: 20px">
              <img :src="item.coverImgUrl" alt="" class="coverImgurl">
              {{item.name}}
            </el-menu-item>
...
export default {
  ...
  mounted () {
    ...
    this.getSongs(userLike.id, userLike.coverImgUrl, userLike.description, userLike.name)
